...
server setVariable [vfs select 4,1500,true];
server setVariable [vfs select 5,450,true];
server setVariable [vfs select 6,14000,true];
server setVariable [vfs select 7,6500,true];
server setVariable [vfs select 8,3000,true];
server setVariable [vfs select 9,3000,true];
server setVariable [vfs select 10,11000,true];

if (activeAFRF) then {
	server setVariable [vfs select 2,6000,true];
	server setVariable [vfs select 11,5000,true];
	server setVariable [vfs select 12,600,true];
	server setVariable [vfs select 13,20000,true];
